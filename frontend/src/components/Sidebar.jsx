...
const Sidebar = ({ isOpen, onClose }) => (
    <>
        ...
        {/* Sidebar */}
        <aside
            className={`fixed left-0 top-0 h-full w-64 bg-[#0d1117] border-r border-[#1e2d3d] flex flex-col z-50 transition-transform duration-300 ease-in-out md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'
                }`}
        >
            {/* Logo area with Close button */}
            <div className="px-6 py-6 border-b border-[#1e2d3d] flex items-center justify-between">
